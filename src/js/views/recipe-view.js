...
class RecipeView extends View {
  ...
  _generateMarkUp() {
    ...
    const isBookMarked = bookMark.some(b => b.id === this._data.id);
    ...
    <div class="recipe__details">
      ...
      <button class="btn--round bookmark" data-bookmark="${isBookMarked}">
  ...
  addHandlerBookMark(handler) {
    this._parentElement.addEventListener('click', e => {
      ...
      const isBookMarked = target.dataset.bookmark === 'true';

      // Toggle icon
      useEl.setAttribute(
        'href',
        `${icons}#${isBookMarked ? 'icon-bookmark' : 'icon-bookmark-fill'}`
      );
